...
<body>
  <div class="main">
    <div class="login-button-area">
      <?php if ($isLoggedIn): ?>
        <a href="../app/views/tarot/app.php">
          <button class="results-button">タロット占い</button>
        </a>
        <a href="../app/views/tarot/tarotresult.php">
          <button class="results-button">占い結果を見る</button>
        </a>
        <a href="../app/views/Q&A/Q&A.php">
          <button class="QA-button">Q&A</button>
        </a>
        <a href="../app/views/user/logout.php">
      ...
      <?php else: ?>
        ...
        <a href="../app/views/user/login.php">
          <button class="login-button">ログイン</button>
        </a>
        <a href="../pubic/index.php">
          <button class="login-button">名前変更</button>
        </a>
      <?php endif; ?>
    </div>
    ...
    <img src="./images/ui/main猫画像.jpg" alt="猫画像">
  </div>
